    ...
    var footerLangs = { 
      //FOOTER ESPAGNOL
        ...
        pt: { // FOOTER PORTUGAIS 
          ...
          form_checkBox1: {
            name: 'Eu li e aceito a Política de Proteção de Dados de ENVISITE e concordo expressamente que meus dados fornecidos aqui sejam usados pela ENVISITE para fins de resposta. ',
              href: 'Política de Proteção de Dados'
          },
          form_newsletter: {
