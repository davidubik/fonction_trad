...
document.querySelector('div#contact.footer-container div#contact-form form div.form-field div.text-field input#name.input-field').innerHTML = footerLangs[lg]['form_name'].name;
document.querySelector('div#contact.footer-container div#contact-form form div.form-field div.text-field input#mail.input-field').innerHTML = footerLangs[lg]['form_mail'].name;
document.querySelector('div#contact.footer-container div#contact-form form div.form-field div.text-field input#tel.input-field').innerHTML = footerLangs[lg]['form_tel'].name;
